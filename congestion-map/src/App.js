...
function App() {
  ...
  const handleVehicleToggle = (vehicleId) => {
    ...
    const updatedSelectedVehicles = updatedVehicleTypes.filter((vehicle) => vehicle.selected).map((vehicle) => vehicle.id);
              ...
              <div className="flex flex-wrap items-center gap-6">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <ChevronDown
                      size={16}
                      className={`transition-transform duration-200 ${showVehicleDropdown ? "rotate-180" : ""}`}
                    />
                  </button>
                    ...
                    <div className="absolute z-10 mt-1 w-48 bg-white rounded-md shadow-lg border border-gray-200">
                      <div className="py-1">
                        {vehicleTypes.map((vehicle) => (
                          ...
                          >
                            <input type="checkbox" checked={vehicle.selected} onChange={() => {}} className="mr-2 h-4 w-4" />
                  ...
                  <>
                    ...
                    {ridershipStats.maxStationName && (
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm">{ridershipStats.maxStationName}</span>
                      </div>
                    )}
                    {ridershipStats.maxCongestionPoint && (
                      <div className="flex items-center justify-between">
                        <span className="text-sm">Peak Entry:</span>
                        <span className="text-sm">{ridershipStats.maxCongestionPoint}</span>
                      </div>
                    )}
